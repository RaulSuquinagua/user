...
var Tab1Page = /** @class */ (function () {
    function Tab1Page(afdb, cartService, common, zone, afAuth, router) {
        var _this = this;
        this.afdb = afdb;
    ...
    Tab1Page.prototype.fetchCategory = function () {
        ...
        this.afdb.list('categories/').snapshotChanges().subscribe(function (res) {
            ...
            var nCat = _this.categories.length / 7;
            var rCat = ((_this.categories.length % 7) / 7);
            var flag = [];
            console.log("fff");
            console.log(rCat);
            console.log(nCat);
    ...
    Tab1Page.prototype.skip = function () {
