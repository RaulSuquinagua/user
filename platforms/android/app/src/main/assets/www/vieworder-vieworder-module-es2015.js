...
let VieworderPage = class VieworderPage {
    constructor(translate, route, afdb, afAuth, common) {
    ...
    ngOnInit() {
        this.afdb.object('orders/' + this.orderId).snapshotChanges().subscribe((order) => {
...
//# sourceMappingURL=vieworder-vieworder-module-es2015.js.map