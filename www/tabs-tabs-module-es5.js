...
var TabsPage = /** @class */ (function () {
    function TabsPage(events, detectorRef, zone, cartService) {
        var _this = this;
        this.events = events;
                ...
                children: [
                    {
                        path: '',
                        loadChildren: function () {
                            return Promise.all(/*! import() | search-search-module */[__webpack_require__.e("common"), __webpack_require__.e("search-search-module")]).then(__webpack_require__.bind(null, /*! ../search/search.module */ "./src/app/search/search.module.ts")).then(function (m) { return m.SearchPageModule; });
                        }
                    }
                ]
            },
